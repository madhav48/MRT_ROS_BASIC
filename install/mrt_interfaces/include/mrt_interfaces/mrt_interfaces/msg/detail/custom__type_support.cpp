...
{
  new (message_memory) mrt_interfaces::msg::Custom(_init);
}

void Custom_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrt_interfaces::msg::Custom *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Custom_message_member_array[4] = {
  {
    ...
    offsetof(mrt_interfaces::msg::Custom, rover_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrt_interfaces::msg::Custom, battery_level),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrt_interfaces::msg::Custom, current_location),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mrt_interfaces::msg::Custom, health_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Custom_message_members = {
  "mrt_interfaces::msg",  // message namespace
  "Custom",  // message name
  4,  // number of fields
  sizeof(mrt_interfaces::msg::Custom),
...
{
  return &::mrt_interfaces::msg::rosidl_typesupport_introspection_cpp::Custom_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrt_interfaces, msg, Custom)() {
  return &::mrt_interfaces::msg::rosidl_typesupport_introspection_cpp::Custom_message_type_support_handle;
}
